...
{
    /// <summary>
    /// IJSONProcessStepInstance
    /// </summary>
    [DataContract]
    public partial class IJSONProcessStepInstance :  IEquatable<IJSONProcessStepInstance>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IJSONProcessStepInstance" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IJSONProcessStepInstance {\n");
        ...
        {
            return this.Equals(input as IJSONProcessStepInstance);
        }

        /// <summary>
        /// Returns true if IJSONProcessStepInstance instances are equal
        /// </summary>
        /// <param name="input">Instance of IJSONProcessStepInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IJSONProcessStepInstance input)
        {
            if (input == null)
                return false;
