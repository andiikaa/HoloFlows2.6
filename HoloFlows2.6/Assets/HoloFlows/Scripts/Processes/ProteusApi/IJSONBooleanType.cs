...
namespace Processes.Proteus.Rest.Model
{
    ...
    public partial class IJSONBooleanType : IJSONType,  IEquatable<IJSONBooleanType>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IJSONBooleanType {\n");
        ...
        {
            return this.Equals(input as IJSONBooleanType);
        }

        /// <summary>
        /// Returns true if IJSONBooleanType instances are equal
        /// </summary>
        /// <param name="input">Instance of IJSONBooleanType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IJSONBooleanType input)
        {
            if (input == null)
                return false;
